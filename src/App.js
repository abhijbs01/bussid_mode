...
function App() {
  return (
    <>
      ...
      <p>
        Mode Bussid indian is committed to protecting your privacy. This Privacy
      ...
      <ul>
        ...
        <li>
          ...
          illegal activities, and protect the rights and property of Jbs
      ...
      <ul>
        <li>
          With Your Consent: We may share or disclose your information with your
        ...
        <li>
          Legal Requirements: We may disclose your information if we are
          required to do so by law or in response to a legal process, such as a
      ...
      <p>
        ...
        policy and, in some cases, we may provide additional notice (such as
        adding a statement to our homepage or sending you a notification). We
        encourage you to review the Privacy Policy whenever you access the App
